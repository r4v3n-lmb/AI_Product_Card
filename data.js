...
window.TERMINAL_SCRIPT = [
  ...
  { t: 'out',    s: 'johannesburg, za  ·  accepting briefs' },

  { t: 'prompt', s: '> load ops_stack --env=production' },
  { t: 'out',    s: 'initialising capability modules...' },
  { t: 'ok',     s: '  [✓] inbound_call_handling       active' },
  { t: 'ok',     s: '  [✓] fleet_dispatch_routing      active' },
  { t: 'ok',     s: '  [✓] client_retention_engine     active' },
  { t: 'ok',     s: '  [✓] high_volume_order_intake    active' },
  { t: 'ok',     s: '  [✓] multilingual_processing     active' },
  { t: 'ok',     s: '  [✓] rag_knowledge_layer         active' },
  { t: 'ok',     s: '  [✓] api_integration_fabric      active' },
  { t: 'ok',     s: '  [✓] observability_layer         active' },
  { t: 'ok',     s: '  [✓] version_controlled_deploy   active' },

  { t: 'prompt', s: '> probe --live' },
  { t: 'out',    s: 'pinging active endpoints...' },
  { t: 'tag',    s: '  whatsapp_agent ............  connected' },
  { t: 'tag',    s: '  dispatch_router ...........  5 drivers synced' },
  { t: 'tag',    s: '  rebook_scheduler ..........  14 triggers queued' },
  { t: 'tag',    s: '  order_intake ..............  kitchen feed live' },
  { t: 'tag',    s: '  lang_processor ............  en / af / fr / de / pt' },
